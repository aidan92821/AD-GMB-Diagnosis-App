...
def qiime_preprocess(bioproject: str, lib_layout: str):
    
    import_samples(bioproject=bioproject,
                   lib_layout=lib_layout)

    trunc = qc(bioproject=bioproject, 
               lib_layout=lib_layout)

    if lib_layout == 'paired':
        dada2_denoise(bioproject=bioproject,
                    lib_layout=lib_layout,
    ...
    classify_taxa(bioproject=bioproject,
                  lib_layout=lib_layout)
